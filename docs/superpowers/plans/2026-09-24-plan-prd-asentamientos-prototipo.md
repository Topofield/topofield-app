...
> **Actualización (mismo día).** Mientras se escribía este plan cerraron las
> fases 15, 16 y 17. La 16 implementó la importación, así que H9 y buena parte
> de D17 ya están resueltos. El usuario eligió **una sola fase** (D1), que
> quedó como la **18**. D2, D5, D9 y D11 las decidió él, y el resto se tomó
> con la recomendación de este plan. El PRD resultante es
> [`prds/17-libreta-panel-asentamientos.md`](../../prds/17-libreta-panel-asentamientos.md).
